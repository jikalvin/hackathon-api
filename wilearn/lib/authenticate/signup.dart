                      ...
                      children: [
                        Expanded(
                          child: OutlinedButton(
                              onPressed: (){
                                context.push('/${RouteNames.signup}/info');
                              },
                              style: ButtonStyle(
                                ...
                                child: ElevatedButton(
                                  onPressed: (){
                                    if(_formKey.currentState!.validate()) {
                                      ...
                                      context.push("/${RouteNames.signup}/credentials");
                                    }
                                  },
                                  style: ButtonStyle(
                                    padding: MaterialStateProperty.all(const EdgeInsets.symmetric(horizontal: 0, vertical: 20)),
...
class SignUpCredentials extends StatefulWidget{
  ...
  @override
  State<SignUpCredentials> createState() => _RegisterUserCredentials();
}

class _RegisterUserCredentials extends State<SignUpCredentials> {
  final _formKey = GlobalKey<FormState>();
  String userEmail = '';
  String userPassword = '';
  String confirmPassword = '';
